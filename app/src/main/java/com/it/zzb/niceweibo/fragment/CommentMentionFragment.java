...
public class CommentMentionFragment extends BaseFragment {
    ...
    public CommentMentionFragment(){

    }

    public static CommentMentionFragment getInstance(String title) {
        CommentMentionFragment fragment = new CommentMentionFragment();
...
//        fragment.setArguments(args);
    ...
    private void loadData() {
        ...
        if (mAccessToken != null && mAccessToken.isSessionValid()) {
            commentsAPI.mentions(0,0,20,1,0,0,mListener);
        } else {
